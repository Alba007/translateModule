...
export class NavbarVerticalStyle2Component implements OnInit, OnDestroy
{
    ...
    {
        this._fuseSidebarService.getSidebar('navbar')? this._fuseSidebarService.getSidebar('navbar').toggleOpen() : null;
    }
    ...
    {
        this._fuseSidebarService.getSidebar('navbar')? this._fuseSidebarService.getSidebar('navbar').toggleFold() : true;
    }
